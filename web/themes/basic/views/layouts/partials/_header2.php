                    ...
                    <div class="navbar-collapse">
                        ...
                        <ul class="nav ml-auto">
                            ...
                            <?php if (Yii::$app->user->isGuest) { ?>
                                ...
                                <li class="nav-item">
                                    <?= Html::a(Yii::t('app', 'BTN_REGISTER'), array('/users/register'), array('class' => 'nav-link')); ?>
                                </li>
                            <?php } else { ?>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                    ...
                                    <div class="dropdown-menu">
                                        <?= Html::a(Html::icon('user') . ' ' . Yii::t('user/default', 'PROFILE'), array('/users/profile'), array('class' => 'dropdown-item')); ?>
                                        ...
                                        if (Yii::$app->user->can('admin')) {
                                            ...
                                            echo Html::a(Html::icon('tools') . ' ' . Yii::t('app/admin', 'ADMIN_PANEL'), array('/admin'), array('class' => 'dropdown-item'));
                                            echo '<div class="dropdown-divider"></div>';
                                       }
                                        ?>
                                        <?= Html::a(Html::icon('logout') . ' ' . Yii::t('user/default', 'LOGOUT'), Url::to(['/users/logout']), array('class' => 'dropdown-item')); ?>
