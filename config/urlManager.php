...
return [
    ...
    'rules' => [
        ...
        ['pattern' => 'admin/<module:[0-9a-zA-Z_\-]+>/<controller:[0-9a-zA-Z_\-]+>/<action:[0-9a-zA-Z_\-]+>', 'route' => '<module>/admin/<controller>/<action>'],
        ['pattern' => 'admin/<module:[0-9a-zA-Z_\-]+>', 'route' => '<module>/admin/default/index'],
        ['pattern' => 'admin/<module:[0-9a-zA-Z_\-]+>/<controller:[0-9a-zA-Z_\-]+>', 'route' => '<module>/admin/<controller>/index'],
        ['pattern' => 'admin/<module:[0-9a-zA-Z_\-]+>/<controller:[0-9a-zA-Z_\-]+>/<action:[0-9a-zA-Z_\-]+>/<page:\d+>', 'route' => '<module>/admin/<controller>/<action>'],
