...
namespace app\common\modules\projectscalc\models\search;

use Yii;
use yii\base\Model;
use panix\engine\data\ActiveDataProvider;
use app\common\modules\projectscalc\models\AgreementsRedaction;

class AgreementsRedactionSearch extends AgreementsRedaction {
    ...
    public function search($params) {
        $query = AgreementsRedaction::find();
